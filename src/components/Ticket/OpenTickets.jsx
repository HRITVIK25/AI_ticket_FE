...
const OpenTickets = () => {
  ...
  const availableTags = [
    "ALL",
    ...Array.from(new Set(tickets.map((t) => t.tag).filter(Boolean))),
  ];
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <Box sx={{ position: "relative", zIndex: 1 }}>
            ...
            >
              Review and monitor all incoming support tickets across your
              organisation.
            </Typography>
          </Box>
        </Box>
        ...
        <TicketList tickets={filtered} onViewDetails={setSelectedTicket} />
